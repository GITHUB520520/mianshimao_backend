...
public class MockInterviewController {
    ...
    public BaseResponse<MockInterview> getMockInterviewById(long id, HttpServletRequest request) {
        ...
        List<MockInterviewChatMessage> messageList = JSONUtil.parseArray(messages).toList(MockInterviewChatMessage.class);
        List<MockInterviewChatMessage> mockInterviewChatMessages = messageList.stream().filter(message ->
                !message.getRole().equals("system")
        ).collect(Collectors.toList());
        mockInterview.setMessages(JSONUtil.toJsonStr(mockInterviewChatMessages));
