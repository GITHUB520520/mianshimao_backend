...
import com.project.interview.model.dto.mockinterview.MockInterviewChatMessage;
...
import com.project.interview.model.enums.MockInterviewEventEnum;
import com.project.interview.model.enums.MockInterviewStatusEnum;
import com.project.interview.service.MockInterviewService;
import com.project.interview.mapper.MockInterviewMapper;
...
public class MockInterviewServiceImpl extends ServiceImpl<MockInterviewMapper, MockInterview>
    ...
    public QueryWrapper<MockInterview> getQueryWrapper(MockInterviewQueryRequest mockInterviewQueryRequest) {
        ...
        if(mockInterviewQueryRequest == null) return queryWrapper;
        ...
        String messages = mockInterviewQueryRequest.getMessages();
    ...
    private String handleChatEndEvent(MockInterview mockInterview) {
        ...
        // 调用 AI 获取结果
        String endAnswer = arkManager.doChat(chatMessages);
    ...
    private String handleChatMessageEvent(MockInterviewEventRequest mockInterviewEventRequest, MockInterview mockInterview) {
        ...
        // 调用 AI 获取结果
        String chatAnswer = arkManager.doChat(chatMessages);
